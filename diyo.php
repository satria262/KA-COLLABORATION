...
<body>
          ...
          <div class="task-columns">
            ...
            <div class="column">
              ...
              <div class="task-card">
                <h5>Mockups</h5>
                <div class="meta">🕒 12 Days</div>
                <p>Create 12 mockups for mobile iPhone 13 Pro Max.</p>
                <div class="task-footer">
                  <span>📎 3 💬 6</span>
                  <div class="avatars">
              ...
              <div class="task-card">
                <h5>UI Animation</h5>
                <div class="meta">🕒 12 Days</div>
                <p>Micro interaction loading and progress, storytelling, navigation.</p>
                <div class="task-footer">
                  <span>📎 2 💬 4</span>
                  <div class="avatars">
            ...
            <div class="column">
              ...
              <div class="task-card">
                ...
                <div class="meta">🕒 12 Days</div>
                <p>Design new user interface for food delivery app.</p>
                <div class="task-footer">
                  <span>📎 2 💬 4</span>
                  <div class="avatars">
              ...
              <div class="task-card">
                ...
                <div class="meta">🕒 12 Days</div>
                <p>Perform usability testing for the newly developed app.</p>
                <div class="task-footer">
                  <span>📎 3 💬 5</span>
                  <div class="avatars">
            ...
            <div class="column">
              ...
              <div class="task-card">
                <h5>Mind Mapping</h5>
                <div class="meta">🕒 12 Days</div>
                <p>Mind mapping for the food delivery app targeting young users.</p>
                <div class="task-footer">
                  <span>📎 7 💬 2</span>
                  <div class="avatars">
              ...
              <div class="task-card">
                <h5>User Feedback</h5>
                <div class="meta">🕒 12 Days</div>
                <p>Perform the user survey and take necessary steps to solve their problems.</p>
                <div class="task-footer">
                  <span>📎 5 💬 8</span>
                  <div class="avatars">
  ...
  <!-- JavaScript proteksi login -->
  <script>
    // Proteksi: hanya user yang sudah login yang bisa akses dashboard
  ...
  <style>
    /* Tambahan sedikit untuk tombol logout */
    .logout-btn {
      margin-top: 30px;
